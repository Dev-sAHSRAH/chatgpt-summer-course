...
async function fetchSynopsis(outline) {
    const response = await openai.createCompletion({
        ...
        he's also fighting for the attention of his beautiful flight instructor, Charlotte Blackwood (Kelly McGillis). Maverick gradually earns the 
        respect of his instructors and peers - and also the love of Charlotte, but struggles to balance his personal and professional life. 
        As the pilots prepare for a mission against a foreign enemy, Maverick must confront his own demons and overcome the tragedies 
...
async function fetchImagePrompt(title, synopsis) {
    ...
    fetchImagePrompt(response.data.choices[0].text.trim());
}
